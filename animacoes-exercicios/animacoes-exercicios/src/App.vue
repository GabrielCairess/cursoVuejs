<template>
  <div id="app" class="container-fluid">
    <!-- <h1>Animações</h1>
    <hr />
    <b-button variant="primary" class="mb-4" @click="mostrarMensagem"
      >Mostrar Mensagem</b-button
    >

    <transition name="fade">
      <b-alert variant="info" show v-show="exibir">{{ mensagem }}</b-alert>
    </transition>
    ...
    <hr />
    <b-button @click="adicionarAluno" class="mb-4 mr-2">
      Adicionar Aluno
    </b-button>
...
export default {
  ...
  data() {
    return {
      ...
      mensagem: "Uma mensagem de informação para usuário",
      exibir: false,
      exibir2: true,
      tipoAnimacao: "fade",
      larguraBase: 0,
